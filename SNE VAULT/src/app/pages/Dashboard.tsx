 ...
 * NEXT_PUBLIC_USE_BACKEND = "true" | "false" (default: false)
 * NEXT_PUBLIC_SNE_API_URL = optional backend proxy for on-chain reads
 *
...
const API_BASE =
  process.env.NEXT_PUBLIC_SNE_API_URL ?? 'https://sne-scroll-pass.vercel.app';
const USE_BACKEND = (process.env.NEXT_PUBLIC_USE_BACKEND ?? 'false') === 'true';
