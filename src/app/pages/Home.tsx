        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            ...
            <Button
              ...
              onClick={() => window.open("https://github.com/SNE-Labs/SNE-Labs", "_blank", "noopener")}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2" style={{ fontSize: "var(--text-body)" }}>
                ...
                <li>
                  <a href="https://github.com/SNE-Labs/SNE-Labs" target="_blank" rel="noopener noreferrer" style={{ color: "var(--sne-text-secondary)" }}>
                    GitHub
                  </a>
                </li>
              </ul>
